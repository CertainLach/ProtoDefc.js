...
function itemsToCompilationUnit(attributesByName) {
    throw new Error('unimplemented');
}
function typeToCompilationUnit(statement) {
    throw new Error('unimplemented');
}
function blockToCompilationUnit(root) {
...
exports.blockToCompilationUnit = blockToCompilationUnit;
